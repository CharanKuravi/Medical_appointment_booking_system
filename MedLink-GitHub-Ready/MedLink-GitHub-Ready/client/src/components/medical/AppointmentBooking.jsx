...
export default function AppointmentBooking({ specialist, onClose }) {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            // Build complete appointment object matching the schema
            ...
            // Call the clean backend - it returns { success, bookingId/error }
            const result = await bookAppointment(appointmentData);

            if (result.success) {
                // ✅ SUCCESS - Show confirmation
                console.log("✅ UI: Booking confirmed with ID:", result.bookingId);
                setConfirmed(true);
                setTimeout(() => {
                    onClose();
                }, 2500);
            ...
            // This should rarely happen now since bookAppointment catches errors
