// Comprehensive medical conditions data organized alphabetically
export const diseasesData = {
    ...
    I: [
        ...
        { name: "Interstitial Cystitis", description: "Chronic bladder pain and pressure", specialists: ["Urologist", "Urogynecologist", "Pain Specialist"] },
    ],
    J: [
    ...
    Q: [
        { name: "Q Fever", description: "Bacterial infection from animals", specialists: ["Infectious Disease", "Pulmonologist", "Internal Medicine"] },
    ],
    R: [
...
export const specialistsInfo = {
    "Neurologist": { expertise: "Brain & Nervous System", availability: "Mon-Fri, 9AM-5PM", location: "Neurology Center", description: "Diagnoses and treats disorders of the nervous system including the brain, spinal cord, and nerves." },
    "Geriatrician": { expertise: "Elderly Care", availability: "Mon-Thu, 8AM-4PM", location: "Senior Health Clinic", description: "Specializes in healthcare for elderly patients and age-related conditions." },
    "Psychiatrist": { expertise: "Mental Health", availability: "Mon-Sat, 10AM-6PM", location: "Mental Wellness Center", description: "Medical doctor specializing in mental health, including substance use disorders." },
    "Pulmonologist": { expertise: "Lung & Respiratory", availability: "Mon-Fri, 8AM-5PM", location: "Respiratory Care Center", description: "Specializes in diseases of the lungs and respiratory tract." },
    "Allergist": { expertise: "Allergies & Immune", availability: "Tue-Sat, 9AM-5PM", location: "Allergy & Immunology Clinic", description: "Diagnoses and treats allergies, asthma, and immune system disorders." },
    ...
    "Rheumatologist": { expertise: "Joints & Autoimmune", availability: "Mon-Fri, 8AM-6PM", location: "Rheumatology Associates", description: "Treats arthritis, autoimmune diseases, and musculoskeletal conditions." },
    "Orthopedic Surgeon": { expertise: "Bones & Joints", availability: "Mon-Fri, 7AM-5PM", location: "Orthopedic Surgery Center", description: "Surgical specialist for musculoskeletal system conditions." },
    "Physical Therapist": { expertise: "Rehabilitation", availability: "Mon-Sat, 7AM-7PM", location: "Physical Therapy Center", description: "Helps patients recover mobility and manage pain through exercises and treatments." },
    ...
    "Internal Medicine": { expertise: "Adult Medicine", availability: "Mon-Fri, 8AM-6PM", location: "Internal Medicine Clinic", description: "Provides comprehensive care for adult patients." },
    ...
    "Psychologist": { expertise: "Behavioral Health", availability: "Mon-Sat, 9AM-7PM", location: "Psychology Practice", description: "Provides therapy and counseling for mental health conditions." },
    "Therapist": { expertise: "Counseling", availability: "Mon-Sat, 10AM-8PM", location: "Counseling Center", description: "Offers various forms of therapy for mental and emotional well-being." },
    ...
    "Emergency Medicine": { expertise: "Acute Care", availability: "24/7", location: "Emergency Department", description: "Provides immediate care for acute illnesses and injuries." },
    ...
    "Urologist": { expertise: "Urinary System", availability: "Mon-Fri, 8AM-5PM", location: "Urology Associates", description: "Treats conditions of the urinary tract and male reproductive organs." },
    ...
    "Endocrinologist": { expertise: "Hormones & Metabolism", availability: "Mon-Fri, 9AM-5PM", location: "Endocrine Center", description: "Treats hormone-related diseases and metabolic conditions." },
    ...
    "Optometrist": { expertise: "Vision Care", availability: "Mon-Sat, 9AM-6PM", location: "Vision Center", description: "Provides eye exams and prescribes corrective lenses." },
    "ENT Specialist": { expertise: "Ear, Nose & Throat", availability: "Mon-Fri, 9AM-5PM", location: "ENT Associates", description: "Treats conditions of the ear, nose, throat, and related structures." },
    "Infectious Disease": { expertise: "Infections", availability: "Mon-Fri, 8AM-5PM", location: "Infectious Disease Center", description: "Specializes in diagnosing and treating infectious diseases." },
    "Hepatologist": { expertise: "Liver", availability: "Mon-Fri, 9AM-5PM", location: "Liver Center", description: "Specializes in liver, gallbladder, and pancreas diseases." },
    "Sleep Medicine Specialist": { expertise: "Sleep Disorders", availability: "Mon-Fri, 9AM-6PM", location: "Sleep Center", description: "Diagnoses and treats sleep-related disorders." },
    "Pain Specialist": { expertise: "Pain Management", availability: "Mon-Fri, 8AM-5PM", location: "Pain Management Center", description: "Specializes in treating chronic and acute pain conditions." },
    "Dietitian": { expertise: "Nutrition", availability: "Mon-Sat, 9AM-6PM", location: "Nutrition Services", description: "Provides dietary guidance and nutrition therapy." },
    "Primary Care": { expertise: "General Health", availability: "Mon-Fri, 8AM-6PM", location: "Primary Care Clinic", description: "Provides comprehensive primary healthcare services." },
    "Vascular Surgeon": { expertise: "Blood Vessels", availability: "Mon-Fri, 8AM-5PM", location: "Vascular Surgery Center", description: "Specializes in surgical treatment of blood vessel conditions." },
    ...
    "Reproductive Endocrinologist": { expertise: "Fertility", availability: "Mon-Fri, 8AM-5PM", location: "Fertility Center", description: "Specializes in reproductive hormones and fertility treatments." },
    "Pediatrician": { expertise: "Children's Health", availability: "Mon-Sat, 8AM-6PM", location: "Pediatric Center", description: "Provides medical care for infants, children, and adolescents." },
    "Audiologist": { expertise: "Hearing", availability: "Mon-Fri, 9AM-5PM", location: "Hearing Center", description: "Specializes in hearing and balance disorders." },
    "Bariatric Surgeon": { expertise: "Weight Loss Surgery", availability: "Mon-Fri, 8AM-4PM", location: "Weight Loss Surgery Center", description: "Performs surgical weight loss procedures." },
